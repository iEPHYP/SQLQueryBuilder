...
export const onBracketClick = (dashed: boolean, onClick: BracketProps['onClick']) => () =>
  onClick(dashed);

export const Bracket = withStyles(bracketStyles)((({ openBracket, dashed, classes, onClick }) => (
