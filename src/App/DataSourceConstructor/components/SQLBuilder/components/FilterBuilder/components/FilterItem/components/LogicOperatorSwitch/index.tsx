...
import { LogicOperatorSwitchProps, LogicOperatorSwitchViewProps as ViewProps } from './props';
import { LogicOperatorSwitch as View } from './view';

export class LogicOperatorSwitch extends React.Component<LogicOperatorSwitchProps> {
