...
import { getFormattedCoupleOperands, getFormattedSingleOperand, hasOperands } from './utils';
...
export const FilterOperandsView: React.FC<FilterOperandsProps> = ({ operation, variables }) => {
  return (
    <>
