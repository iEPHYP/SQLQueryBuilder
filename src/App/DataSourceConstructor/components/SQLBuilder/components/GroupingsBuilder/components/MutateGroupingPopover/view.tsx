...
export const MutateGroupingPopover: React.FC<MutateGroupingPopoverViewProps> = (props) => {
  const { popoverPositionUpdater, onColumnSelected, canShowColumnBranch } = props;
