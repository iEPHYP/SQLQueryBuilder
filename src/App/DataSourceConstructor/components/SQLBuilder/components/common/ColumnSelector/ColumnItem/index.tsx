...
import { ColumnItemProps, ColumnItemViewProps as ViewProps, IColumnItemHandlers } from './props';
  ...
  implements IColumnItemHandlers
{
  ...
  public handleColumnClick: ViewProps['handleColumnClick'] = () => {
    const { columnBranch, onColumnSelected, popoverPositionUpdater } = this.props;
