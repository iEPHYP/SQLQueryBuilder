...
import { ColumnSelectorOwnProps, ColumnSelectorProps, ColumnSelectorStateProps } from './props';
import { getRootTableBranch } from './utils';
import { TableColumns } from './view';

export const initialLevel: 0 = 0;

export const ColumnSelector = connect<ColumnSelectorStateProps, {}, ColumnSelectorOwnProps, State>(
