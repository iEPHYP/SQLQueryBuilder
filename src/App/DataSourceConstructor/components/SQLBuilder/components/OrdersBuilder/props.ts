...
export type OrdersBuilderStateProps = PickStates<'orders' | 'aggregations' | 'groupings'>;

export type OrdersBuilderProps = OrdersBuilderStateProps;
export type OrdersBuilderViewProps = OrdersBuilderStateProps & ClassesProp<OrdersBuilderClassKeys>;
