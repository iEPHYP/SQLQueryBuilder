...
export type MutateOrderPopoverProps = MutateOrderPopoverOwnProps & MutateOrderPopoverStateProps;
...
export type MutateOrderPopoverState = Pick<ColumnSelectorProps, 'popoverPositionUpdater'>;
