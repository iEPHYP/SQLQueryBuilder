...
export class MutateAggregationPopover extends React.Component<PropsType, StateType> {
  ...
  public positionUpdaterCallback: PopoverPaperProps['positionUpdaterCallback'] = (
  ...
  public handleColumnSelection: ViewProps['onColumnSelected'] = (column) => {
    ...
    action(new Aggregation(aggregation ? aggregation : {}, { operator, column }));
  ...
  public canShowColumnBranch: ViewProps['canShowColumnBranch'] = ({ lastColumn: { type } }) => {
    const { operator } = this.state;
