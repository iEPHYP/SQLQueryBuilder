...
export type AddCustomColumnAction = Action<'ADD_CUSTOM_COLUMN', { customColumn: CustomColumn }>;
...
export type RemoveCustomColumnAction = Action<'REMOVE_CUSTOM_COLUMN', { id: CustomColumn['id'] }>;
...
export const addCustomColumn = (customColumn: CustomColumn): AddCustomColumnAction => ({
  type: 'ADD_CUSTOM_COLUMN',
  customColumn,
});

export const updateCustomColumn = (customColumn: CustomColumn): UpdateCustomColumnAction => ({
  type: 'UPDATE_CUSTOM_COLUMN',
  customColumn,
});

export const removeCustomColumn = (id: CustomColumn['id']): RemoveCustomColumnAction => ({
