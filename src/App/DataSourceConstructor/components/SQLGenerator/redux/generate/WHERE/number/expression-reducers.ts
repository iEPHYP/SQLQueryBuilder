import { NumberOperands } from 'App/DataSourceConstructor/components/SQLBuilder/components/FilterBuilder/components/MutateFilterPopover/SwitchMutator/mutators/NumberMutator/NumberOperation';
import { NumberOperator } from 'App/DataSourceConstructor/components/SQLBuilder/components/FilterBuilder/components/MutateFilterPopover/SwitchMutator/mutators/NumberMutator/operators';

import { emptyExpressionReducers } from '../empty-expression-reducers';
import { ExpressionReducer } from '../expression-reducer.model';

export type NumberExpressionReducer<TNumberOperands extends NumberOperands = any> =
  ExpressionReducer<TNumberOperands>;

export const reduceSingleOperandExpression =
  (operator: string): NumberExpressionReducer<number> =>
  (column, operands) =>
