...
export const sqlQuery: Reducer<SQLGeneratorState['sqlQuery'], SetSQLQueryAction> = (
  state = '',
  { type, query }
) => {
...
export const queryJson: Reducer<SQLGeneratorState['queryJson'], SetQueryJsonAction> = (
  state = new QueryJSON(),
  { type, queryJson: newQueryJson }
) => {
