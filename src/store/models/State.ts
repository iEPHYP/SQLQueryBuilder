import { DataSourceConstructorState } from 'App/DataSourceConstructor/redux/state';

import { GlobalErrorState } from '../global-error/state';
import { VariablesState } from '../variables/state';

export type State = DataSourceConstructorState & GlobalErrorState & VariablesState;
